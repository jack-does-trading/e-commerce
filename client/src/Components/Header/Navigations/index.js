                    ...
                    <div className="row">
                        <div className="col-sm-2 navPart1">
                            <div className='catWrapper'>
                                <Button className='allCatTab align-items-center' onClick={()=>setisopenSidebarVal(
                                    !isopenSidebarVal
                                )}>
                                ...
                                <div className={`sidebarNav ${isopenSidebarVal===true?'open':''}`}><ul>
                                    <li><Link to='/cat/1'><Button>men<FaAngleRight className='ml-auto'/></Button></Link>
                        ...
                        <div className="col-sm-10 navPart2 d-flex align-items-center">
                            <ul className='list list-inline ml-auto'>
                                ...
                                <li className='list-inline-item'><Link to='/cat/1'><Button>Men</Button></Link>
