                    ...
                    <form className="mt-3">
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                <div className="form-group">
                                    <TextField label="Name" required variant="standard" className="w-100" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-group">
                                    <TextField label="Phone No." required variant="standard" className="w-100" />
                                </div>
                            </div>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="d-flex align-items-center mt-3 mb-3 d-flex">
                            <div className="row w-100">
                                <div className="col-md-6">
                                <Button className="w-100 btn-blue btn-lg col btn-big w-100 mt-3 mb-3">Sign In</Button>
                                </div>
                                <div className="col-md-6 pr-0">
                                <Link to='/' className="w-100"> <Button className="w-100 btn-lg btn-big col mt-3 mb-3" onClick={() => context.setisHeaderFooterShow(true)} 
                        ...
                        <p className="txt">Already Registered?<Link to='/signIn' className="border-effect">Sign Ip</Link> </p>
